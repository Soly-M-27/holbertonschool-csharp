...
namespace Enemies
{
    ...
    public class Zombie
    {
        ...
        /// <summary>
        /// Override ToString to print Zombie object's attributes
        /// </summary>
        /// <returns>Zombie objects's attributes</returns>
        public override string ToString()
        {
            return $"Zombie Name: {this._name} / Total Health: {this._health}";
        }
    }
}
