...
public class MatrixMath
{
    ...
    {
        if (matrix1.GetLength(0) == matrix2.GetLength(0) == matrix1.GetLength(1) == matrix2.GetLength(1) == 2)
        {
            double[,] res = {{0, 0}, {0, 0}}; 
        ...
        else if (matrix1.GetLength(0) == matrix2.GetLength(0) == matrix1.GetLength(1) == matrix2.GetLength(1) == 3)
        {
